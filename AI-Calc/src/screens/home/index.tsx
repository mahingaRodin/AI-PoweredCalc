...
const Home: React.FC = () => {
  ...
  const sendData = async () => {
    ...
    if (canvas) {
      ...
      const resp = await response.data; // Assuming response.data is an array
    ...
    <>
      <div className="grid grid-cols-3 gap-2">
        ...
        <Group className="z-20">
          {COLOR_SWATCHES.map((swatchColor: string) => (
            <ColorSwatch
              key={swatchColor}
              color={swatchColor}
      ...
      <canvas
        ...
        onMouseMove={draw} // Add onMouseMove to handle drawing
      />
